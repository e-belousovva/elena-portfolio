    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="flex items-center justify-between h-16 gap-3">
            ...
            <nav class="hidden md:flex items-center gap-6">
                ...
                <a href="{{ route('home') }}#services" class="text-sm text-white/50 hover:text-white transition-colors font-mono">{{ __('portfolio.nav.cases') }}</a>
        ...
        >
            ...
            <a href="{{ route('home') }}#services" @click="mobileOpen = false" class="mobile-nav-link">{{ __('portfolio.nav.cases') }}</a>
